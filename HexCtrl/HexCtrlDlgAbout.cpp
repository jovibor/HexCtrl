...
BOOL CHexDlgAbout::OnInitDialog()
{
	...
	GetDlgItem(IDC_HEXCTRL_ABOUT_STATIC_LINKGITHUB)->SetWindowTextW(HEXCTRL_LINKGITHUB_WSTR);
...
void CHexDlgAbout::OnLButtonDown(UINT nFlags, CPoint point)
{
	...
	if (pWnd->GetDlgCtrlID() == IDC_HEXCTRL_ABOUT_STATIC_LINKGITHUB)
		ShellExecute(nullptr, L"open", HEXCTRL_LINKGITHUB_WSTR, nullptr, nullptr, NULL);
