...
namespace HEXCTRL::INTERNAL
{
	...
	public:
		...
		[[nodiscard]] auto GetData()const->std::vector<HEXSPAN>;
		...
		void SetSelection(const std::vector<HEXSPAN>& vecSel, bool fHighlight); //Set a selection or selection highlight.
		void SetSelStartEnd(ULONGLONG ullOffset, bool fStart); //fStart true - Start, false - End.
	private:
		std::vector<HEXSPAN> m_vecSelection { };         //Selection data vector.
		std::vector<HEXSPAN> m_vecSelHighlight { };      //Selection highlight data vector.
