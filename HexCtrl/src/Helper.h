...
#define TO_STR_HELPER(x) L## #x
#define TO_STR(x) TO_STR_HELPER(x)
#ifdef _WIN64
#define HEXCTRL_VERSION_WSTR HEXCTRL_PRODUCT_NAME L", v" TO_STR(HEXCTRL_VERSION_MAJOR) L"."\
		TO_STR(HEXCTRL_VERSION_MINOR) L"." TO_STR(HEXCTRL_VERSION_MAINTENANCE) L" (x64)"
#else
#define HEXCTRL_VERSION_WSTR HEXCTRL_PRODUCT_NAME L", v" TO_STR(HEXCTRL_VERSION_MAJOR) L"."\
		TO_STR(HEXCTRL_VERSION_MINOR) L"." TO_STR(HEXCTRL_VERSION_MAINTENANCE) L" (x86)"
#endif
};