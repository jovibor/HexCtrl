...
namespace HEXCTRL
{
	...
	********************************************************************************************/
	...
	public:
		...
		[[nodiscard]] virtual DWORD GetDateInfo()const = 0;                  //Get current date format info.
		...
		[[nodiscard]] virtual wchar_t GetUnprintableChar()const = 0;     //Set unprintable replacement character
		...
		virtual void SetDateInfo(DWORD dwDateFormat) = 0;      //Set date format, e.g. -1=User default, 0=MMddYYYY, 1=ddMMYYYY, 2=YYYYMMdd
		...
		virtual void SetUnprintableChar(wchar_t wcUnprintable) = 0; //Set unprintable replacement character
