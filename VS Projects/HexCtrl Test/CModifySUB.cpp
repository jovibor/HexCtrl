...
public:
	TEST_METHOD(OperInt8) {
		...
		ModifyHexCtrlAndRefData<TestType>(OPER_SUB, 2);
	...
	TEST_METHOD(OperInt16) {
		...
		CreateRandomTestData();
		ModifyHexCtrlAndRefData<TestType>(OPER_SUB, 12);
		CompareHexCtrlAndRefData<TestType>();
	}
	...
	TEST_METHOD(OperInt32) {
		...
		CreateRandomTestData();
		ModifyHexCtrlAndRefData<TestType>(OPER_SUB, 123);
		CompareHexCtrlAndRefData<TestType>();
	}
	...
	TEST_METHOD(OperInt64) {
		...
		CreateRandomTestData();
		ModifyHexCtrlAndRefData<TestType>(OPER_SUB, 1234);
		CompareHexCtrlAndRefData<TestType>();
	}
	...
	TEST_METHOD(OperFloat) {
		...
		CreateRandomTestData();
		ModifyHexCtrlAndRefData<TestType>(OPER_SUB, 123.8765432F);
		CompareHexCtrlAndRefData<TestType>();
	}
	TEST_METHOD(OperDouble) {
		using TestType = double;
		CreateRandomTestData();
		ModifyHexCtrlAndRefData<TestType>(OPER_SUB, 123.8765432);
		CompareHexCtrlAndRefData<TestType>();
	}
	...
	TEST_METHOD(OperInt16BE) {
		using TestType = std::int16_t;
		CreateRandomTestData();
		ModifyHexCtrlAndRefData<TestType>(OPER_SUB, 12, true);
		CompareHexCtrlAndRefData<TestType>();
	}
	...
	TEST_METHOD(OperInt32BE) {
		using TestType = std::int32_t;
		CreateRandomTestData();
		ModifyHexCtrlAndRefData<TestType>(OPER_SUB, 123, true);
		CompareHexCtrlAndRefData<TestType>();
	}
	...
	TEST_METHOD(OperInt64BE) {
		using TestType = std::int64_t;
		CreateRandomTestData();
		ModifyHexCtrlAndRefData<TestType>(OPER_SUB, 1234, true);
		CompareHexCtrlAndRefData<TestType>();
	}
	...
	TEST_METHOD(OperFloatBE) {
		using TestType = float;
		CreateRandomTestData();
		ModifyHexCtrlAndRefData<TestType>(OPER_SUB, 123.8765432F, true);
		CompareHexCtrlAndRefData<TestType>();
	}
	TEST_METHOD(OperDoubleBE) {
		using TestType = double;
		CreateRandomTestData();
		ModifyHexCtrlAndRefData<TestType>(OPER_SUB, 123.8765432, true);
		CompareHexCtrlAndRefData<TestType>();
	}
	};
}