...
public:
	TEST_METHOD(OperInt8) {
		...
		ModifyHexCtrlAndRefData<TestType>(OPER_OR, 0x55);
	...
	TEST_METHOD(OperInt16) {
		...
		CreateRandomTestData();
		ModifyHexCtrlAndRefData<TestType>(OPER_OR, 0x5555);
		CompareHexCtrlAndRefData<TestType>();
	}
	...
	TEST_METHOD(OperInt32) {
		...
		CreateRandomTestData();
		ModifyHexCtrlAndRefData<TestType>(OPER_OR, 0x55555555);
		CompareHexCtrlAndRefData<TestType>();
	}
	...
	TEST_METHOD(OperInt64) {
		...
		CreateRandomTestData();
		ModifyHexCtrlAndRefData<TestType>(OPER_OR, 0x5555555555555555);
		CompareHexCtrlAndRefData<TestType>();
	}
	...
	TEST_METHOD(OperInt16BE) {
		using TestType = std::int16_t;
		CreateRandomTestData();
		ModifyHexCtrlAndRefData<TestType>(OPER_OR, 0x5555, true);
		CompareHexCtrlAndRefData<TestType>();
	}
	...
	TEST_METHOD(OperInt32BE) {
		using TestType = std::int32_t;
		CreateRandomTestData();
		ModifyHexCtrlAndRefData<TestType>(OPER_OR, 0x55555555, true);
		CompareHexCtrlAndRefData<TestType>();
	}
	...
	TEST_METHOD(OperInt64BE) {
		using TestType = std::int64_t;
		CreateRandomTestData();
		ModifyHexCtrlAndRefData<TestType>(OPER_OR, 0x5555555555555555, true);
		CompareHexCtrlAndRefData<TestType>();
	}
