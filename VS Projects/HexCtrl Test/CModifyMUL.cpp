...
public:
	TEST_METHOD(OperInt8) {
		...
		OperDataForType<TestType>(OPER_MUL, 2);
	...
	TEST_METHOD(OperInt16) {
		...
		CreateRandomTestData();
		OperDataForType<TestType>(OPER_MUL, 12);
		VerifyDataForType<TestType>();
	}
	...
	TEST_METHOD(OperInt32) {
		...
		CreateRandomTestData();
		OperDataForType<TestType>(OPER_MUL, 123);
		VerifyDataForType<TestType>();
	}
	...
	TEST_METHOD(OperInt64) {
		...
		CreateRandomTestData();
		OperDataForType<TestType>(OPER_MUL, 1234);
		VerifyDataForType<TestType>();
	}
	...
	TEST_METHOD(OperFloat) {
		...
		CreateRandomTestData();
		OperDataForType<TestType>(OPER_MUL, 12.8765432F);
		VerifyDataForType<TestType>();
	}
	TEST_METHOD(OperDouble) {
		using TestType = double;
		CreateRandomTestData();
		OperDataForType<TestType>(OPER_MUL, 12.8765432);
		VerifyDataForType<TestType>();
	}
	...
	TEST_METHOD(OperInt16BE) {
		using TestType = std::int16_t;
		CreateRandomTestData();
		OperDataForType<TestType>(OPER_MUL, 12, true);
		VerifyDataForType<TestType>();
	}
	...
	TEST_METHOD(OperInt32BE) {
		using TestType = std::int32_t;
		CreateRandomTestData();
		OperDataForType<TestType>(OPER_MUL, 123, true);
		VerifyDataForType<TestType>();
	}
	...
	TEST_METHOD(OperInt64BE) {
		using TestType = std::int64_t;
		CreateRandomTestData();
		OperDataForType<TestType>(OPER_MUL, 1234, true);
		VerifyDataForType<TestType>();
	}
	...
	TEST_METHOD(OperFloatBE) {
		using TestType = float;
		CreateRandomTestData();
		OperDataForType<TestType>(OPER_MUL, 12.8765432F, true);
		VerifyDataForType<TestType>();
	}
	TEST_METHOD(OperDoubleBE) {
		using TestType = double;
		CreateRandomTestData();
		OperDataForType<TestType>(OPER_MUL, 12.8765432, true);
		VerifyDataForType<TestType>();
	}
	};
}