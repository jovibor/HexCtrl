...
public:
	...
	void OperTData(T tData, HEXSPAN hsp) {
		ModifyOperTData(OPER_ROTL, tData, hsp);
	}
	...
	TEST_METHOD(OperInt8) {
		...
		constexpr std::int8_t i8Oper = 1;
		constexpr std::int8_t i8Result = std::rotl(static_cast<std::uint8_t>(i8Set), i8Oper);
	...
	TEST_METHOD(OperUInt8) {
		...
		constexpr std::uint8_t ui8Oper = 1;
		constexpr std::uint8_t ui8Result = std::rotl(ui8Set, ui8Oper);
		const HEXSPAN hss { 0, m_pHex->GetDataSize() };
	...
	TEST_METHOD(OperInt16) {
		...
		constexpr std::int16_t i16Oper = 1;
		constexpr std::int16_t i16Result = std::rotl(static_cast<std::uint16_t>(i16Set), i16Oper);
		const HEXSPAN hss { 0, m_pHex->GetDataSize() };
	...
	TEST_METHOD(OperUInt16) {
		...
		constexpr std::uint16_t ui16Oper = 1;
		constexpr std::uint16_t ui16Result = std::rotl(ui16Set, ui16Oper);
		const HEXSPAN hss { 0, m_pHex->GetDataSize() };
	...
	TEST_METHOD(OperInt32) {
		...
		constexpr std::int32_t i32Oper = 1;
		constexpr std::int32_t i32Result = std::rotl(static_cast<std::uint32_t>(i32Set), i32Oper);
		const HEXSPAN hss { 0, m_pHex->GetDataSize() };
	...
	TEST_METHOD(OperUInt32) {
		...
		constexpr std::uint32_t ui32Oper = 1;
		constexpr std::uint32_t ui32Result = std::rotl(ui32Set, ui32Oper);
		const HEXSPAN hss { 0, m_pHex->GetDataSize() };
	...
	TEST_METHOD(OperInt64) {
		...
		constexpr std::int64_t i64Oper = 1;
		constexpr std::int64_t i64Result = std::rotl(static_cast<std::uint64_t>(i64Set), i64Oper);
		const HEXSPAN hss { 0, m_pHex->GetDataSize() };
	...
	TEST_METHOD(OperUInt64) {
		...
		constexpr std::uint64_t ui64Oper = 1;
		constexpr std::uint64_t ui64Result = std::rotl(ui64Set, ui64Oper);
		const HEXSPAN hss { 0, m_pHex->GetDataSize() };
